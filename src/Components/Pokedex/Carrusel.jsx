...
const Carrucel = (props) =>{
    ...
    return(
        <>
            <div onClick={()=>indice != 0 ? setIndice(indice - 1) : setIndice(0)} className='btn-carrusel' >
            ...
            <div className="container-carrusel">
                ...
                {indice}
                {
                    props.pokemon.map((x, i) =>{
                        if(indice <= i && i <= (indice+5) ){ return <div onClick={()=>props.cambiarPokemon(i)} className="elemento">
                        ...
                        <div className='elemento-left'>
                            ...
                            <div className="elemento-grafico">
                                ...
                                <p>{x.stats[0].base_stat}/{x.stats[0].base_stat}</p>
                            </div>
                        </div>
                    </div>}
                    })
            ...
            <div onClick={()=>indice == 144? setIndice(144) : setIndice(indice + 1)} className='btn-carrusel'>
