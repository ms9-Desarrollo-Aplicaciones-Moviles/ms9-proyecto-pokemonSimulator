	...
	return (
		<>
				...
				<div className="container-info-pokemon">
					...
					<div className="info-pokemon">
						<div className="group-info">
							<p className="m-0">Altura</p>
							<span>{pokemon.height / 10} Metros</span>
						</div>
						<div className="group-info">
							<p className="m-0">Peso</p>
							<span>{pokemon.weight / 10} Kilogramos</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="contenedor-pokebola">
				<h2>Volver ➡ </h2>
				<div className="pokebola" type="button" onClick={() => path('/pokedex')}>
